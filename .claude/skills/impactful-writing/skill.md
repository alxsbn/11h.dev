...
1. **Draft fast**: Get ideas down without self-editing
2. **Read aloud**: Clunky sentences reveal themselves
3. **Cut 20%**: First drafts are always too long
4. **Check transitions**: Every paragraph break is a potential exit point
5. **End strong**: The last line should linger
