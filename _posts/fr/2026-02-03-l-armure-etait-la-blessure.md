...
L'armure était la blessure. Il m'a fallu sept ans pour le voir.

Pas la complexité en elle-même, pas les cinquante modèles, les pipelines ou les systèmes parallèles. Tout ça, c'étaient des symptômes. La blessure, c'était ceci : une équipe data incapable de démontrer sa valeur analytique s'était réorganisée de sorte que le coût de l'auditer dépasse le coût de la garder. La complexité n'était pas de l'architecture. C'était le prix de la question que personne ne pouvait se permettre de poser.
