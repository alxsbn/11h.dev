---
layout: post
title: "Data that can't contradict you is useless"
date: 2026-06-16
categories: [data, ai]
...
In [*Being and Nothingness*](https://en.wikipedia.org/wiki/Being_and_Nothingness), [Sartre](https://en.wikipedia.org/wiki/Jean-Paul_Sartre) put it in his own terms: we all long to be loved freely. But a proof obtained under pressure stops, precisely, being a proof, and the only "I love you" that counts is the one you never had to extract.

With data, it's often the same story.

In many companies, the numbers aren't there to decide but to make a decision acceptable after the fact. So we drown in [indicators, analyses and dashboards](/en/2025/02/08/lost-in-the-data-fog-your-company-might-be-overdos/). Then we pick the ones that let us say: "I'm not the one who chose, the data did."
...
This is an idea [Karl Popper](https://en.wikipedia.org/wiki/Karl_Popper) placed at the heart of his account of knowledge. A theory isn't interesting because we've found examples that confirm it. It becomes interesting when we expose it to a test that could refute it.
